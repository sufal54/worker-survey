...
export const dashboardResponseByNumber = async (req: VercelRequest, res: VercelResponse) => {
    try {
...
export const adminRevokeCertification = async (req: VercelRequest, res: VercelResponse) => {
    try {
