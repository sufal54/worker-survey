                        ...
                        <PieChart>
                          <Tooltip
                            formatter={(value, name, props) => {
                              const total =
                                demographicBreakdown?.departments?.reduce(
                          ...
                          <Pie
                            ...
                            labelLine={false}
                          >
                            {(demographicBreakdown?.departments || []).map((entry, index) => (
                              <Cell
                                key={`cell-dept-${index}`}
                                fill={
                                  [
                      ...
                      <ResponsiveContainer width="100%" height={260}>
                        <PieChart>
                          <Tooltip
                            formatter={(value, name, props) => {
                              const total =
                                demographicBreakdown?.educationLevels?.reduce(
                                  (sum, item) => sum + item.count,
                                  0
                                ) ?? 0;
                          ...
                          <Pie
                            ...
                            labelLine={false}
                          >
                            {(demographicBreakdown?.educationLevels || []).map((entry, index) => (
                              <Cell
                                key={`cell-edu-${index}`}
                                fill={
                                  [
                      ...
                      <ResponsiveContainer width="100%" height={260}>
                        <PieChart>
                          <Tooltip
                            formatter={(value, name, props) => {
                              const total =
                                demographicBreakdown?.tenures?.reduce(
                                  (sum, item) => sum + item.count,
                                  0
                                ) ?? 0;
                          ...
                          <Pie
                            ...
                            labelLine={false}
                          >
                            {(demographicBreakdown?.tenures || []).map((entry, index) => (
                              <Cell
                                key={`cell-tenure-${index}`}
                                fill={
                                  [
                                    "#f59e0b",
                                    "#3b82f6",
                      ...
                      <ResponsiveContainer width="100%" height={260}>
                        <PieChart>
                          <Tooltip
                            formatter={(value, name, props) => {
                              const total =
                                demographicBreakdown?.ages?.reduce(
                                  (sum, item) => sum + item.count,
                                  0
                                ) ?? 0;
                          ...
                          <Pie
                            data={demographicBreakdown?.ages || []}
                            dataKey="count"
                            nameKey="name"
                            cx="50%"
                            cy="50%"
                            ...
                            labelLine={false}
                          >
                            {(demographicBreakdown?.ages || []).map((entry, index) => (
                              <Cell
                                key={`cell-age-${index}`}
                                fill={
                                  [
