...
export const surveyQuestions: SurveyQuestion[] = [
  ...
  { id: 18, text: "I am proud of the organization's culture.", section: "Employee Wellbeing & Happiness", sectionLetter: "B" },
  ...
  { id: 30, text: "I recive feedback that helps me improve my performance.", section: "Culture & Communication", sectionLetter: "C" },
